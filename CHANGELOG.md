...
#### ✨ Features (新特性)
- **config**: 新增卖出手续费、整数精度、宏观调控固定更新时间与偏倚上限等配置项。
...
#### 🐛 Bug Fixes (修复)
- **history**: 日/周视图历史窗口对齐开市时间，减少跨日偏移导致的视觉错位。
- **precision**: 统一价格与金额的格式化逻辑，避免浮点误差与精度不一致。
